...
const links = [
	{ id: 1, name: "Sobre nosotros", href: "/about" },
	{ id: 2, name: "Vinilos", href: "/vinyls" },
	{ id: 3, name: "Inicio", href: "/" },
	{ id: 4, name: "Política de privacidad", href: "/privacy" },
];
		...
		<footer className="mt-4">
			<section className="w-full max-w-screen-xl p-4 mx-auto md:py-8">
				...
				<span className="block text-sm font-medium text-center text-gray-500 dark:text-gray-400">
					&copy; {new Date().getFullYear()} Jose Sánchez.
				</span>
			</section>
		</footer>
	);
